...
- port 7889 for mainnet,
- port 17889 for testnet,
- port 27889 for testnet4,
- port 37889 for scalenet,
...
<https://github.com/fittexxcoin/bips/blob/master/bip-0064.mediawiki>

Example:

```
$ curl localhost:17889/rest/getutxos/checkmempool/b2cdfd7b89def827ff8af7cd9bff7627ff72e5e8b0f71210f92ea7a4000c5d75-0.json 2>/dev/null | json_pp
{
...
Running a web browser on the same node with a REST enabled fittexxcoind can be a risk.
Accessing prepared XSS websites could read out tx/block data of your node by placing
links like `<script src="http://127.0.0.1:7889/rest/tx/1234567890.json">` which
