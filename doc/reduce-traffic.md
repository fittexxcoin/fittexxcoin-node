...
By default, Fittexxcoin Node allows up to 125 connections to different peers,
...
limits are tiny. Keep in mind that fittexxcoin's trustless model works best if you are
