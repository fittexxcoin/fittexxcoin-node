...
Fittexxcoin Node has an internal benchmarking framework, with benchmarks
...
The benchmarks can be run and built using `ninja bench-fittexxcoin`.
This produces and runs the benchmarking executable `src/bench/bench_fittexxcoin`.
