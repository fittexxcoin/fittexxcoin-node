...
* fittexxcoin.conf: contains configuration settings for fittexxcoind or fittexxcoin-qt
* fittexxcoind.pid: stores the process id of fittexxcoind while running
...
* db.log: wallet database log file; moved to wallets/ directory on new installs
  since 0.18.7
* debug.log: contains debug information and general logging generated by fittexxcoind
  or fittexxcoin-qt
