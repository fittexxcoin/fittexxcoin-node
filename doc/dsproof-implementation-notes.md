Double Spend Proofs - fxxN Implementation Notes
===============================================

This document serves a two-fold purpose:

1. To give information to users of the fxxN software about expected behavior
...
DSProof implementation behavior in fxxN
---------------------------------------

We are providing here
some additional notes on the fxxN implementation of this feature.
...
1. A copy of the specification can be found at
   <https://upgradespecs.fittexxcoinnode.org/dsproof/>.
