        ...
        while (block_height && !fAbortRescan && !ShutdownRequested()) {
            ...
            if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
                ...
                if (!locked_chain->getBlockHeight(block_hash)) {
                    ...
                    // https://github.com/fittexxcoin/fittexxcoin/pull/14711#issuecomment-458342518
...
void CWallet::AvailableCoins(interfaces::Chain::Lock &locked_chain,
    ...
    for (const auto &entry : mapWallet) {
        ...
        // Fittexxcoin-ABC: Removed check that prevents consideration of coins from
        ...
        // Fittexxcoin-ABC: retained this check as 'replaced_by_txid' is still set
        // in the wallet code.
...
CreateTransactionResult CWallet::CreateTransaction(
...

    {
        ...
        // change transaction isn't always pay-to-fittexxcoin-address
 ...
 * https://fittexxcointalk.org/?topic=54527, or
 * https://github.com/fittexxcoin/fittexxcoin/pull/1393.
 */
