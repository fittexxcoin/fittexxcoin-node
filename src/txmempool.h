...
public:
     ...
     * https://github.com/fittexxcoin/fittexxcoin/pull/14193 will fix it. No known code
     * in fittexxcoin currently depends on second guarantee, but it is important to
