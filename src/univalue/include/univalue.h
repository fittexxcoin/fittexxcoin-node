...
// Copyright 2015 Fittexxcoin Core Developers
...
public:
     ...
     * VFALSE and VTRUE are Fittexxcoin Node extensions of the UniValue API (replacing VBOOL).
     */
    enum VType {
        VNULL  = 1 << 0,
        VFALSE = 1 << 1,
     ...
     * Can be used with is().
     *
     * This is a Fittexxcoin Node extension of the UniValue API.
     */
...
public:
     ...
     *
     * Compatible with the upstream UniValue API.
     * Non-const overload is a Fittexxcoin Node extension.
     */
