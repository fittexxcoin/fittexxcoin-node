...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_valid) {
    static const std::string CASES[] = {
        ...
        "PREFIX:X64NX6HZ",
        "p:gpf8m4h7",
        "fittexxcoin:qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn",
        "fxxtest:testnetaddress4d6njnut",
        "fxxreg:555555555555555555555555555555555555555555555udxmlmrz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_invalid) {
    static const std::string CASES[] = {
        ...
        "prefix:",
        ":u9wsx07j",
        "fxxreg:555555555555555555x55555555555555555555555555udxmlmrz",
        "fxxreg:555555555555555555555555555555551555555555555udxmlmrz",
        "pre:fix:x32nx6hz",
        "prefixx64nx6hz",
    };
