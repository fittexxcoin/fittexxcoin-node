// Copyright (C) 2018 The Fittexxcoin Unlimited developers
...
/*!
  Fittexxcoin extended version message implementation.

  This version message de-/serializes the same fields as the version
  message format as in the BU fxx implementation as of July 2018.
