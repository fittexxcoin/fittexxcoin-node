...
/**
 * Fittexxcoin protocol message types. When adding new message types, don't forget
 ...
 * @see https://fittexxcoin.org/en/developer-reference#version
 */
extern const char *const VERSION;
/**
 * The verack message acknowledges a previously-received version message,
 * informing the connecting node that it can begin to send other messages.
 * @see https://fittexxcoin.org/en/developer-reference#verack
 */
extern const char *const VERACK;
/**
 * The addr (IP address) message relays connection information for peers on the
 * network.
 * @see https://fittexxcoin.org/en/developer-reference#addr
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#inv
 */
extern const char *const INV;
/**
 * The getdata message requests one or more data objects from another node.
 * @see https://fittexxcoin.org/en/developer-reference#getdata
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#merkleblock
 */
extern const char *const MERKLEBLOCK;
/**
 * The getblocks message requests an inv message that provides block header
 * hashes starting from a particular point in the block chain.
 * @see https://fittexxcoin.org/en/developer-reference#getblocks
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#getheaders
 */
extern const char *const GETHEADERS;
/**
 * The tx message transmits a single transaction.
 * @see https://fittexxcoin.org/en/developer-reference#tx
 */
 ...
 * @since protocol version 31800.
 * @see https://fittexxcoin.org/en/developer-reference#headers
 */
extern const char *const HEADERS;
/**
 * The block message transmits a single serialized block.
 * @see https://fittexxcoin.org/en/developer-reference#block
 */
extern const char *const BLOCK;
/**
 * The getaddr message requests an addr message from the receiving node,
 * preferably one with lots of IP addresses of other receiving nodes.
 * @see https://fittexxcoin.org/en/developer-reference#getaddr
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#mempool
 */
extern const char *const MEMPOOL;
/**
 * The ping message is sent periodically to help confirm that the receiving
 * peer is still connected.
 * @see https://fittexxcoin.org/en/developer-reference#ping
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#pong
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#notfound
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#filterload
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://fittexxcoin.org/en/developer-reference#filteradd
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://fittexxcoin.org/en/developer-reference#filterclear
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#reject
 */
 ...
 * @see https://fittexxcoin.org/en/developer-reference#sendheaders
 */
...
enum ServiceFlags : uint64_t {
    ...
    // chain. It is currently set by all Fittexxcoin Node non pruned nodes, and is
    // unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo
    // protocol request. Fittexxcoin Node does not support this but a patch set
    // called Fittexxcoin XT does. See BIP 64 for details on how this is
    // implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered
    // connections. Fittexxcoin Node nodes used to support this by default, without
    ...
    NODE_XTHIN = (1 << 4),
    // NODE_FITTEXXCOIN_CASH means the node supports Fittexxcoin and the
    // associated consensus rule changes.
    // This service bit is intended to be used prior until some time after the
    // UAHF activation when the Fittexxcoin network has adequately separated.
    // TODO: remove (free up) the NODE_FITTEXXCOIN_CASH service bit once no longer
    // needed.
    NODE_FITTEXXCOIN_CASH = (1 << 5),
    ...
    // fittexxcoin-development mailing list. Remember that service bits are just
...
public:
    ...
    SERIALIZE_METHODS(CAddress, obj) {
        ...
        if ((s.GetType() & SER_DISK) || (nVersion != INIT_PROTO_VERSION && !(s.GetType() & SER_GETHASH))) {
            ...
            // uses INIT_PROTO_VERSION. Currently extversion in fxxN does not
