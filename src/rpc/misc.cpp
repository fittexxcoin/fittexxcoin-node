    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given Fittexxcoin address.\n",
                {
                    {"address", RPCArg::Type::STR, /* opt */ false, /* default_val */ "", "The Fittexxcoin address to validate"},
                }}
                .ToString() +
            "\nResult:\n"
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3) {
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, /* opt */ false, /* default_val */ "", "The Fittexxcoin address to use for the signature."},
    ...
    if (request.fHelp) {
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "fittexxcoin-cli and the GUI. There is no server-side difference.",
                {}}
                .ToString() +
            "");
    }
...
static UniValue getinfo_deprecated(const Config &config,
    ...
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
                       ...
                       "\nfittexxcoin-cli has the option -getinfo to collect and "
