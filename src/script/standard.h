 ...
 *  A CTxDestination is the internal data type encoded in a Fittexxcoin address
 */
...
/**
 * Generate a Fittexxcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
