...
/**
 * Fittexxcoin GUI main class. This class represents the main window of the Fittexxcoin
 * UI. It communicates with both the client and wallet models to give the user
 * an up-to-date view of the current core state.
 */
class FittexxcoinGUI : public QMainWindow {
    Q_OBJECT

public:
    static const std::string DEFAULT_UIPLATFORM;

    explicit FittexxcoinGUI(interfaces::Node &node, const Config *,
