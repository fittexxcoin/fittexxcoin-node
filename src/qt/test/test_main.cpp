...
int main(int argc, char *argv[]) {
    ...
    ClearDatadirCache();
    fs::path pathTemp =
        fs::temp_directory_path() / strprintf("test_fittexxcoin-qt_%lu_%i",
    ...
    FittexxcoinApplication app(*node, argc, argv);
    app.setApplicationName("FittexxcoinNode-Qt-test");
    ...
    FittexxcoinAddressValidatorTests test6;
