...
//! Entry point for FittexxcoinApplication tests.
void AppTests::appTests() {
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping AppTests on mac build with 'minimal' platform set due "
              ...
              "with 'test_fittexxcoin-qt -platform cocoa' on mac, or else use a "
    ...
    connect(&m_app, &FittexxcoinApplication::windowShown, this,
            &AppTests::guiTests);
...
//! Entry point for FittexxcoinGUI tests.
void AppTests::guiTests(FittexxcoinGUI *window) {
    HandleCallback callback{"guiTests", *this};
    connect(window, &FittexxcoinGUI::consoleShown, this, &AppTests::consoleTests);
