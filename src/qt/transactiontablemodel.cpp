...
TransactionTableModel::TransactionTableModel(
    ...
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label")
            << FittexxcoinUnits::getAmountColumnTitle(
...
void TransactionTableModel::updateAmountColumnTitle() {
    columns[Amount] = FittexxcoinUnits::getAmountColumnTitle(
        walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(
    ...
    FittexxcoinUnits::SeparatorStyle separators) const {
    QString str =
        FittexxcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(),
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const {
    ...
    switch (role) {
        ...
        case TxPlainTextRole: {
            ...
            details.append(
                formatTxAmount(rec, false, FittexxcoinUnits::separatorNever));
            return details;
        }
        case ConfirmedRole:
        ...
        case FormattedAmountRole:
            ...
            return formatTxAmount(rec, false, FittexxcoinUnits::separatorNever);
        case StatusRole:
