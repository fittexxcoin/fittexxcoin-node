...
void TransactionView::changedAmount() {
    ...
    if (auto amount_parsed = FittexxcoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), true, amountWidget->text())) {
...
void TransactionView::exportClicked() {
    ...
    writer.addColumn(FittexxcoinUnits::getAmountColumnTitle(
