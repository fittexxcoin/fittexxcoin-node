...
void OptionsModel::Init(bool resetSettings) {
    ...
    // Display
    constexpr auto defaultDisplayUnit = FittexxcoinUnits::fxx;
...
void OptionsModel::checkAndMigrate() {
    ...
    if (settingsVersion < CLIENT_VERSION) {
        ...
        // see https://github.com/fittexxcoin/fittexxcoin/pull/8273
    ...
    if (settings.contains("nDisplayUnit") && !settings.contains("nDisplayUnit_v2")) {
        ...
        if (FittexxcoinUnits::valid(oldVal))
