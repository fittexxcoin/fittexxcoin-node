#!/usr/bin/env python3
# Copyright (c) 2013-2017 The Fittexxcoin Core developers
...
# Fittexxcoin specification.
PATTERN_AGENT = re.compile(
    r"^(/Fittexxcoin Node:2[456]\.(\d+)\.(\d+)[^/]*/"
    r"|/Flowee:1[^/]*/|/kth-fxx:0\.[23][0-9]\.(\d+)[^/]*/"
    r"|/fxxd:0\.(20|1[89])\.(\d+)[^/]*/"
    r"|/Fittexxcoin Verde:2\.(\d+)\.(\d+)[^/]*/"
    r"|/fxx Unlimited:1\.(9|1[01])\.(\d+)[^/]*/)")
...
def main():
    ...
    # Filter out hosts with multiple fittexxcoin ports, these are likely abusive
