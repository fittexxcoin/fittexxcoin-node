...
class BenchmarkFile(object):
    ...
    def from_file(self, filename):
        ...
        with open(filename, newline='', encoding='utf-8') as csvfile:
            ...
            # Skip field comment header in bench_fittexxcoin's CSV output
            next(csv_reader)
...
def main():
    ...
    parser = argparse.ArgumentParser(add_help=False,
                                     ...
                                     description=__doc__,
                                     epilog='''
    `before_file` and `after_file` must be outputs of bench_fittexxcoin program and include the commented header line.''',
