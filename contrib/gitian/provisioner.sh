...
echo "export URL=https://gitlab.com/fittexxcoin-node/fittexxcoin-node.git"
echo "cd gitian-builder"
echo "./bin/make-base-vm --lxc --distro debian --suite stretch --arch amd64"
echo "./bin/gbuild --commit fittexxcoin=\${COMMIT} --url fittexxcoin=\${URL} /vagrant/contrib/gitian-descriptors/gitian-linux.yml"
