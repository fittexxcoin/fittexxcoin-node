...
from test_framework.test_framework import FittexxcoinTestFramework # noqa: E402
...
# TestNode: A peer we use to send messages to fittexxcoind, and store responses.
...
class StressTest(FittexxcoinTestFramework):
