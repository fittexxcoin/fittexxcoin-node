...
# Copyright 2016-2017 The Fittexxcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for fittexxcoin utils.
...
def main():
    ...
    bctester(os.path.join(config["environment"]["SRCDIR"], "test",
                          "util", "data"), "fittexxcoin-util-test.json", config["environment"])
...
def bctest(testDir, testObj, buildenv):
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, fittexxcoin-tx
