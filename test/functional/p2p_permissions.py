...
class P2PPermissionsTests(FittexxcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].fittexxcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].fittexxcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
