...
"""Verify that starting fittexxcoin with -h works as expected."""
import subprocess
...
class HelpTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fittexxcoin with -h for help text")
        ...
        self.log.info("Start fittexxcoin with -version for version information")
        ...
        self.log.info(
            "Start fittexxcoind with -fakearg to make sure it does not start")
