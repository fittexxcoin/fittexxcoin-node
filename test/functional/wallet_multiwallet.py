...
Verify that a fittexxcoind node can load multiple wallet files
"""
import os
import shutil
import time
...
class MultiWalletTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # https://github.com/fittexxcoin/fittexxcoin/issues/14304
        assert_raises_rpc_error(-1, "BerkeleyBatch: Can't open database w8_copy (duplicates fileid",
                                self.nodes[0].loadwallet, 'w8_copy')
