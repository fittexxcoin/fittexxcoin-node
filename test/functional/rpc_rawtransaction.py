...
from test_framework.test_framework import FittexxcoinTestFramework, get_datadir_path
...
class RawTransactionsTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "data array must contain at least one element",
                                self.nodes[0].createrawtransaction, [], {'data': []})
        assert_raises_rpc_error(-5, "Invalid Fittexxcoin address",
