...
class WalletTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 fxx from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 fxx with subtract fee from amount
        ...
        # Sendmany 10 fxx with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/fittexxcoin/fittexxcoin/issues/7463
            # '-salvagewallet',
        ]
        ...
        assert_equal(address_info['address'],
                     "fxxreg:qp8rs4qyd3aazk22eyzwg7fmdfzmxm02pywavdajx4")
