...
"""Fittexxcoin test framework primitive and message structures

CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
    data structures that should map to corresponding structures in
    fittexxcoin/primitives
...
# Objects that map to fittexxcoind objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/fittexxcoin/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in fittexxcoind indicates these should be deserialized as blocks
