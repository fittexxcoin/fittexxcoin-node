...
# fittexxcoind -regtest -debug=net
# fittexxcoin-cli -regtest setmocktime 1643252767
# fittexxcoin-cli -regtest setban 28.0.0.0/8 add
# fittexxcoin-cli -regtest setban 188.162.251.56/32 add
# fittexxcoin-cli -regtest setban 189.7.128.0/24 add
# fittexxcoin-cli -regtest setban 9908:8554:2487:5277::/64 add
# fittexxcoin-cli -regtest setban de41:b9a8:b178:52f:f639:e9bf:4ae3:dca8 add
# fittexxcoin-cli -regtest listbanned
# fittexxcoin-cli -regtest stop


class DeserializeBanlistTest(FittexxcoinTestFramework):
