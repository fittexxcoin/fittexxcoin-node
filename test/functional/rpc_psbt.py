...
class PSBTTest(FittexxcoinTestFramework):
...
class fxxNIssue440Test (FittexxcoinTestFramework):
    '''
    Regression test for bugfix (backport of D6029, D6030) for fxxN issue #440
    https://gitlab.com/fittexxcoin-node/fittexxcoin-node/-/issues/440
    '''
    def set_test_params(self):
        self.num_nodes = 2
    ...
    def run_test(self):
        ...
        # Fund the first address with 0.5 fxx
