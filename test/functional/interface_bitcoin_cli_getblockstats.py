...
"""Test fittexxcoin-cli getblockstats"""
...
class TestFittexxcoinCliGetBlockStats(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Testing `fittexxcoin-cli getblockstats 0`")
        ...
        self.log.info("Testing `fittexxcoin-cli getblockstats '\"{}\"'`".format(block_0_hash))
...
if __name__ == '__main__':
    TestFittexxcoinCliGetBlockStats().main()
