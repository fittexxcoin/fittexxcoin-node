...
# Copyright (c) 2015-2017 The Fittexxcoin Unlimited developers
# Copyright (c) 2020 The Fittexxcoin developers
#
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test validateblocktemplate RPC call. Adapted from fxxUnlimited
test for fxxN specific behavior (slightly different error strings
...
class ValidateblocktemplateTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: fxxN does not have RPC method like BU's 'setminingmaxblocksize' yet,
