...
class AbandonConflictTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Verify that B and C's 10 fxx outputs are available for spending again
        ...
        # Invalidate the block with the double spend and B's 10 fxx output should no longer be available
