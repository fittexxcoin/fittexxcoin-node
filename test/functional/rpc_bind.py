...
"""Test running fittexxcoind with the -rpcbind and -rpcallowip options."""
...
class RPCBindTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # https://reviews.fittexxcoinabc.org/T400 for details).
