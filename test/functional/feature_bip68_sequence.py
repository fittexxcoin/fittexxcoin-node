...
class BIP68Test(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        print("Note that with current versions of fittexxcoin software, nVersion=2 transactions are always standard (independent of BIP68 activation status).")
