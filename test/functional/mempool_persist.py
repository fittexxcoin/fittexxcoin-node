...
By default, fittexxcoind will dump mempool on shutdown and
...
class MempoolPersistTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug(
            "Prevent fittexxcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
