...
Refers to fxxN GitLab https://gitlab.com/fittexxcoin-node/fittexxcoin-node/-/issues/225
and scenarios raised for investigation by TG @readdotcash in
https://fittexxcoinresearch.org/t/specific-needs-for-increasing-or-removing-chained-tx-limit/240"""
...
class MempoolPackagesAdditionalTest(FittexxcoinTestFramework):
