...
def custom_function():
    ...
    # outside the FittexxcoinTestFramework
    pass


class ExampleTest(FittexxcoinTestFramework):
    # Each functional test is a subclass of the FittexxcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        FittexxcoinTestFramework class so other tests can use it."""
