...
class CashTokenRPCTest(FittexxcoinTestFramework):
    ...
    def create_token_genesis_tx(self, node, to_addr, fxx_amount, token_amount, nft=None, fee=Decimal('0.00001'),
                                capability='minting'):
        utxos = dict()
        ...
        while self.get_total_amount(utxos) < fxx_amount + fee:
            for utxo in node.listunspent():
        ...
        amount_change = amount_in - fxx_amount - fee
        ...
        txhex = node.createrawtransaction(
            ...
            [{to_addr: {"amount": fxx_amount, "tokenData": token_data}}] + change_outs
        )
