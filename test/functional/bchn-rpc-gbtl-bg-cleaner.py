...
class GBTLightBGCleanerTest(FittexxcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 2  # We need connected nodes for getblocktemplatelight RPC to function (fittexxcoind node policy)
        self._cache_size = 5
        self._store_time = 10
        args = [
