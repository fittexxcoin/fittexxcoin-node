...
class WalletSendToTokenAwareCashAddr(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 1 fxx to a "token aware" p2pkh address owned by node1, and verify node1 sees the balance change
        ...
        # Send 1 fxx to a "token aware" p2sh address owned by node1, and verify node1 sees the balance change
