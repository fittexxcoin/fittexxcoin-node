#!/usr/bin/env python3
# Copyright (c) 2016-2017 The Fittexxcoin Core developers
...
class WalletLabelsTest(FittexxcoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Fittexxcoins
